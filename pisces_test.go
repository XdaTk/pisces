...
func TestPiscesStatic(t *testing.T) {
	e := New()
...
func TestPiscesFile(t *testing.T) {
	e := New()
...
func TestPiscesMiddleware(t *testing.T) {
	e := New()
...
func TestPiscesMiddlewareError(t *testing.T) {
	e := New()
	e.Use(func(next HandlerFunc) HandlerFunc {
		return func(c Context) error {
...
func TestPiscesHandler(t *testing.T) {
	e := New()
...
func TestPiscesWrapHandler(t *testing.T) {
	e := New()
	req := httptest.NewRequest(http.MethodGet, "/", nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
...
func TestPiscesWrapMiddleware(t *testing.T) {
	e := New()
	req := httptest.NewRequest(http.MethodGet, "/", nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
...
func TestPiscesConnect(t *testing.T) {
	e := New()
	testMethod(t, http.MethodConnect, "/", e)
}

func TestPiscesDelete(t *testing.T) {
	e := New()
	testMethod(t, http.MethodDelete, "/", e)
}

func TestPiscesGet(t *testing.T) {
	e := New()
	testMethod(t, http.MethodGet, "/", e)
}

func TestPiscesHead(t *testing.T) {
	e := New()
	testMethod(t, http.MethodHead, "/", e)
}

func TestPiscesOptions(t *testing.T) {
	e := New()
	testMethod(t, http.MethodOptions, "/", e)
}

func TestPiscesPatch(t *testing.T) {
	e := New()
	testMethod(t, http.MethodPatch, "/", e)
}

func TestPiscesPost(t *testing.T) {
	e := New()
	testMethod(t, http.MethodPost, "/", e)
}

func TestPiscesPut(t *testing.T) {
	e := New()
	testMethod(t, http.MethodPut, "/", e)
}

func TestPiscesTrace(t *testing.T) {
	e := New()
	testMethod(t, http.MethodTrace, "/", e)
}

func TestPiscesAny(t *testing.T) { // JFC
	e := New()
...
func TestPiscesMatch(t *testing.T) { // JFC
	e := New()
...
func TestPiscesURL(t *testing.T) {
	e := New()
...
func TestPiscesRoutes(t *testing.T) {
	e := New()
	routes := []*Route{
...
func TestPiscesEncodedPath(t *testing.T) {
	e := New()
...
func TestPiscesGroup(t *testing.T) {
	e := New()
	buf := new(bytes.Buffer)
...
func TestPiscesNotFound(t *testing.T) {
	e := New()
...
func TestPiscesMethodNotAllowed(t *testing.T) {
	e := New()
	e.GET("/", func(c Context) error {
		return c.String(http.StatusOK, "Pisces!")
	})
...
func TestPiscesContext(t *testing.T) {
	e := New()
	c := e.AcquireContext()
...
func TestPiscesStart(t *testing.T) {
	e := New()
	go func() {
...
func testMethod(t *testing.T, method, path string, e *Pisces) {
...
func request(method, path string, e *Pisces) (int, string) {
...
func TestPiscesClose(t *testing.T) {
	e := New()
...
func TestPiscesShutdown(t *testing.T) {
	e := New()
	errCh := make(chan error)
